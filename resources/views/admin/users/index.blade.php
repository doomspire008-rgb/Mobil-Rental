            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="py-4 px-6">
                            @if($user->role === 'admin')
                                <span class="badge-primary">🛡️ Administrator</span>
                            @else
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-md w-full p-6 animate-fade-in">
        ...
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" class="input" placeholder="Ulangi kata sandi" required minlength="8">
            </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-md w-full p-6 animate-fade-in">
        ...
        <form id="form-reset-password" method="POST" action="" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" class="input" placeholder="Ulangi kata sandi baru" required minlength="8">
            </div>
